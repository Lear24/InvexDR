%% The main experiment with sig varies: ex2-pi4
%% Setting parameters
clear all;
clc
rng('default')
...
%% 
% load('SimuV2_varsig_ex2pi4_rep100.mat')
for rep = 1:repetition
    ...
    if rep ==5, save('SimuV2_varsig_ex2pi4_rep5.mat'), end
    if rep ==10, save('SimuV2_varsig_ex2pi4_rep10.mat'), end

    save('SimuV2_varsig_ex2pi4_rep100.mat')
end
