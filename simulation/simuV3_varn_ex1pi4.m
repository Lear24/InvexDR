...
for rep = 1:repetition
    ...
    if rep ==5, save('SimuV2_varn_ex1pi4_rep5.mat'), end
    if rep ==10, save('SimuV2_varn_ex1pi4_rep10.mat'), end

    save('SimuV2_varn_ex1pi4_rep100.mat')
end
...
% saveas(1,'simuv2_varn_ex1pi4_Tr.png')
% saveas(2,'simuv2_varn_ex1pi4_F.png')
...
% saveas(3,'simuv2_varn_ex1pi4_dTr.png')
% saveas(4,'simuv2_varn_ex1pi4_dF.png')