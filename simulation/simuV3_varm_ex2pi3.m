%% The main experiment with m varies: ex2-pi3
%% Setting parameters
clear all;
clc
rng('default')
...
% load('SimuV2_varm_ex2pi3_rep100.mat')
for rep = 1:repetition
    ...
    if rep ==5, save('SimuV2_varm_ex2pi3_rep5.mat'), end
    if rep ==10, save('SimuV2_varm_ex2pi3_rep10.mat'), end

    save('SimuV2_varm_ex2pi3_rep100.mat')
end
...
saveas(1,'simuv2_varm_ex2pi3_Tr.png')
saveas(2,'simuv2_varm_ex2pi3_F.png')
