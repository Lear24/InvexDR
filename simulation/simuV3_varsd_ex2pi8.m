%% The ain experiment with sd varies: ex2-pi8
%% Setting parameters
clear all;
clc
rng('default')
...
n_all(:,i) = round((N-500)*r(:,1)/sum(r(:,1)));
...
%% 
% load('SimuV2_varsd_ex2pi8_rep100.mat')
for rep = 1:repetition
    ...
    if rep ==5, save('SimuV2_varsd_ex2pi8_rep5.mat'), end
    if rep ==10, save('SimuV2_varsd_ex2pi8_rep10.mat'), end

    save('SimuV2_varsd_ex2pi8_rep100.mat')
end
