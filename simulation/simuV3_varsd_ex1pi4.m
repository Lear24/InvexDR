%% The ain experiment with sd varies: ex1-pi4
%% Setting parameters
clear all;
clc
rng('default')
...
%% 
% load('SimuV2_varsd_ex1pi4_rep100.mat')
for rep = 1:repetition
    ...
    if rep ==5, save('SimuV2_varsd_ex1pi4_rep5.mat'), end
    if rep ==10, save('SimuV2_varsd_ex1pi4_rep10.mat'), end

    save('SimuV2_varsd_ex1pi4_rep100.mat')
end

%%
% clear
clc
% load('SimuV2_varn_ex1pi4_rep100.mat')
