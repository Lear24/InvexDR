%% The main experiment with n varies: ex1-pi8
%% Setting parameters
clear all;
clc
rng('default')
...
for rep = 1:repetition
    ...
    if rep ==5, save('SimuV2_varn_ex1pi8_rep5.mat'), end
    if rep ==10, save('SimuV2_varn_ex1pi8_rep10.mat'), end

    save('SimuV2_varn_ex1pi8_rep100.mat')
end
...
% saveas(1,'simuv2_varn_ex1pi8_Tr.png')
% saveas(2,'simuv2_varn_ex1pi8_F.png')
...
% saveas(3,'simuv2_varn_ex1pi8_dTr.png')
% saveas(4,'simuv2_varn_ex1pi8_dF.png')